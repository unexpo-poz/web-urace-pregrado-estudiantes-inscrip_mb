...
$laBitacora			= $_SERVER[DOCUMENT_ROOT].'/log/pregrado/estudiantes/inscripcion/inscripcion_mb'.$lapsoProceso.'.log';
...
$mensajeppal = "Disculpe, el proceso de inscripci&oacute;n finaliz&oacute;.";
